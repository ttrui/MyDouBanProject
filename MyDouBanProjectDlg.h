...
public:
	afx_msg void OnStnClickedStaticQuery();
	afx_msg void OnStnClickedStaticPages();
	afx_msg void OnStnClickedStaticNow();
	afx_msg void OnStnClickedStaticRecords();
	afx_msg void OnCbnSelchangeComboQueryWay();
