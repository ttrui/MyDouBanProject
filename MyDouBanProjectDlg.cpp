...
BEGIN_MESSAGE_MAP(CMyDouBanProjectDlg, CDialog)
	...
	//}}AFX_MSG_MAP
	ON_STN_CLICKED(IDC_STATIC_QUERY, &CMyDouBanProjectDlg::OnStnClickedStaticQuery)
	ON_STN_CLICKED(IDC_STATIC_PAGES, &CMyDouBanProjectDlg::OnStnClickedStaticPages)
	ON_STN_CLICKED(IDC_STATIC_NOW, &CMyDouBanProjectDlg::OnStnClickedStaticNow)
	ON_STN_CLICKED(IDC_STATIC_RECORDS, &CMyDouBanProjectDlg::OnStnClickedStaticRecords)
	ON_CBN_SELCHANGE(IDC_COMBO_QUERY_WAY, &CMyDouBanProjectDlg::OnCbnSelchangeComboQueryWay)
	ON_NOTIFY(LVN_ITEMCHANGED, IDC_LIST_BOOK, &CMyDouBanProjectDlg::OnLvnItemchangedListBook)
END_MESSAGE_MAP()
...
void CMyDouBanProjectDlg::Initial()
{
	...
	m_BookList.InsertColumn(0, _T("ID"), LVCFMT_LEFT, 150);
	m_BookList.InsertColumn(1, _T("书名"), LVCFMT_LEFT, 200);
	m_BookList.InsertColumn(2, _T("作者"), LVCFMT_LEFT, 200);
	m_BookList.InsertColumn(3, _T("出版社"), LVCFMT_LEFT, 160);
	m_BookList.InsertColumn(4, _T("出版时间"), LVCFMT_LEFT, 150);
...
void CMyDouBanProjectDlg::OnStnClickedStaticQuery()
{
	// TODO: 在此添加控件通知处理程序代码
}


void CMyDouBanProjectDlg::OnStnClickedStaticPages()
{
	// TODO: 在此添加控件通知处理程序代码
}


void CMyDouBanProjectDlg::OnStnClickedStaticNow()
{
	// TODO: 在此添加控件通知处理程序代码
}


void CMyDouBanProjectDlg::OnStnClickedStaticRecords()
{
	// TODO: 在此添加控件通知处理程序代码
}


void CMyDouBanProjectDlg::OnCbnSelchangeComboQueryWay()
{
	// TODO: 在此添加控件通知处理程序代码
}


void CMyDouBanProjectDlg::OnLvnItemchangedListBook(NMHDR *pNMHDR, LRESULT *pResult)
{
